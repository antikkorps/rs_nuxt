...
const links = [
  ...
  { name: "Posts", href: "/posts", icon: "mdi:post" },
...
<template>
  <aside
    class="hidden sm:flex flex-col w-1/6 dark:bg-neutral-800 bg-neutral-100 h-screen justify-between px-4 sticky top-0 left-0 z-50"
  >
